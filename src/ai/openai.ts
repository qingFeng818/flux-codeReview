  ...
  constructor(config: AiProviderConfig) {
    ...
    if (isOpenRouter) {
      ...
      clientOptions.defaultHeaders = {
        'HTTP-Referer': 'https://github.com/qingFeng818/flux-codeReview',
      ...
      if (config.model.includes('/')) {
        clientOptions.defaultHeaders['HTTP-Referer'] = `https://github.com/qingFeng818/flux-codeReview (${config.model})`
      }
    }
